      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="prose prose-invert prose-slate max-w-none space-y-6">
          ...
          <ul className="list-disc pl-6 space-y-3 text-slate-400">
            <li>
              <strong className="text-slate-200">Brand mentions across the web</strong> &mdash; The
              more frequently your brand is discussed on authoritative websites, the more likely AI
              models are to reference it.
            </li>
            <li>
              <strong className="text-slate-200">Sentiment and context</strong> &mdash; Positive
              reviews, case studies, and expert endorsements signal quality to AI models.
            </li>
            <li>
              <strong className="text-slate-200">Structured, clear content</strong> &mdash; AI
              models parse content more effectively when it uses clear headings, comparisons, and
              factual claims.
            </li>
            <li>
              <strong className="text-slate-200">Recency and relevance</strong> &mdash; Fresh
